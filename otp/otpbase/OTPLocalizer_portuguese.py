...
ActivateChat = """O recurso Amigos verdadeiros só permite que um associado converse com outro mediante um código de amigo verdadeiro que deve ser comunicado fora do jogo. Para obter uma descrição completa do recurso, clique aqui: O recurso Amigos verdadeiros não é moderado nem supervisionado. Se os pais deixarem seus filhos usarem a conta com o recurso Amigos verdadeiros ativado, aconselhamos que eles mesmos supervisionem os filhos durante a brincadeira. Depois que for ativado, o recurso Amigos verdadeiros ficará disponível até que alguém o desative. Ao ativar o recurso Amigos verdadeiros, você reconhece que, apesar de haver alguns riscos inerentes a ele, você foi informado de todos os riscos mencionados aqui, concordando em aceitá-los."""
...
NCRepeatedChar = "O seu nome contém muitos caracteres '%s'"
...
NCPeriodUsage = ('Este nome não usa pontos corretamente. Os pontos são '
                 ' permitidos somente em palavras como "Sr.", "Sra.", "J.T." etc.')
